...
ASOPlayerCameraManager::ASOPlayerCameraManager()
{
...
void ASOPlayerCameraManager::OnPossess(AALSBaseCharacter* NewCharacter)
{
...
float ASOPlayerCameraManager::GetCameraBehaviorParam(FName CurveName) const
{
...
void ASOPlayerCameraManager::UpdateViewTargetInternal(FTViewTarget& OutVT, float DeltaTime)
{
...
FVector ASOPlayerCameraManager::CalculateAxisIndependentLag(FVector CurrentLocation, FVector TargetLocation,
...
bool ASOPlayerCameraManager::CustomCameraBehavior(float DeltaTime, FVector& Location, FRotator& Rotation, float& FOV)
{
